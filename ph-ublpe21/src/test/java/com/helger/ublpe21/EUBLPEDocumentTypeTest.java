...
/**
 * Test class for class {@link EUBL21PEDocumentType}.
 *
...
public final class EUBLPEDocumentTypeTest
{
  ...
  public void testAll ()
  {
    for (final EUBL21PEDocumentType e : EUBL21PEDocumentType.values ())
    {
      ...
      assertSame (e, EUBL21PEDocumentType.valueOf (e.name ()));
    }
  }
}
